...
class DateTimeTest {
    ...
    public static void testParse() {
        ...
        LocalDate birthday1 = LocalDate.of(1990,8,02);
    ...
    public static void testFormat() {
        ...
        String date1 = hastings.format(formatter1);
        System.out.println(date1 + "  formatter1");
        // TODO: 14-10-1066
        DateTimeFormatter formatter2 = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        String date2 = hastings.format(formatter2);
        System.out.println(date2 + "  formatter2");
