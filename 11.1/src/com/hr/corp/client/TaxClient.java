...
//        Cooperation extends the interface TaxPayer. This means an instatiated  cooperation class object fulfills the requiremnts of methods that require it's implemented interface TaxPaper'
        irs.register(corp);
//        irs.register takes the interface TaxPayer as it's argument and coopertaion class implments the TaxPayer interface so you can use the cooperation class for irs.register
