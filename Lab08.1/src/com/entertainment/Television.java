...
public class Television {
    ...
    //        We are using the setter from Tuner because we instatiating a tuner object above allowing us to use it's intsnce methods in the current method changeChannel. We instatiated a tuner object and made it one of the fields of this class Television
...
//        We are using the setter from Tuner because we instatiated a tuner object above allowing us to use it's intsnce methods in the current method changeChannel. We instatiated a tuner object and made it one of the fields of this class Television
    }

    public String getCurrentChannel(){
        return tuner.getChannel();
        //        We are using the getter from Tuner because we instatiated a tuner object above allowing us to use it's intsnce methods in the current method changeChannel. We instatiated a tuner object and made it one of the fields of this class Television
