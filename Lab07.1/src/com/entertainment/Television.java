...
//
//    Initialization: The = sign initializes the display field with the value DisplayType.LED. This means that by default, when a new com.entertainment.Television object is created, its display field will be set to DisplayType.LED.
//
